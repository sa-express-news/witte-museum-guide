...
class Map extends Component {
  ...
  render() {
    ...
    return (
      <Map className="the-map" center={position} zoom={state.zoom}>
        <TileLayer
          url='https://api.mapbox.com/styles/v1/saen-editors/cizd0pmz7008w2so57vazf1g4/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1Ijoic2Flbi1lZGl0b3JzIiwiYSI6ImNpeXVreTZ6YjAwenYycW15d3hoNmp1aTEifQ.OjH869qC5JzcGVVy-rg4JQ'
        />
...
config.tileLayer = {
  uri: 'https://api.mapbox.com/styles/v1/saen-editors/cizd0pmz7008w2so57vazf1g4/tiles/256/{z}/{x}/{y}',
  params: {
    minZoom: 11,
    id: '',
    accessToken: 'pk.eyJ1Ijoic2Flbi1lZGl0b3JzIiwiYSI6ImNpeXVreTZ6YjAwenYycW15d3hoNmp1aTEifQ.OjH869qC5JzcGVVy-rg4JQ'
  }
};
